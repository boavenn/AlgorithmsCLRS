...
class EdmondsCarpTest
{
    ...
    void returnCorrectOutputForSmallGraph() {
        ...
        assertEquals(23, EdmondsCarp.process(graph, createVertex("s"), createVertex("t")));
    }
    ...
    void returnCorrectOutputForMediumGraph() {
        ...
        assertEquals(31, EdmondsCarp.process(graph, createVertex(0), createVertex(7)));
    }
}