...
class PushRelabelFifoTest
{
    ...
    void returnCorrectOutputForSmallGraph() {
        ...
        assertEquals(23, PushRelabelFifo.process(graph, createVertex("s"), createVertex("t")));
    }
    ...
    void returnCorrectOutputForMediumGraph() {
        ...
        assertEquals(31, PushRelabelFifo.process(graph, createVertex(0), createVertex(7)));
    }
}